...
import com.hcmut.moneymanagement.activity.IncomeAndExpense.ListViewModel;

import java.util.ArrayList;

public class MyArrayAdapter extends ArrayAdapter<com.hcmut.moneymanagement.activity.IncomeAndExpense.ListViewModel> {

    Activity context = null;
    int layoutId;
    ArrayList<com.hcmut.moneymanagement.activity.IncomeAndExpense.ListViewModel> arr = null;
    //Contructor này dùng để lấy về những giá trị được truyền vào từ Activity
    public MyArrayAdapter(Activity context, int layoutId, ArrayList<com.hcmut.moneymanagement.activity.IncomeAndExpense.ListViewModel> list){
