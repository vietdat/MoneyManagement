...
public class EventHis extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager, int months) {
        ...
        if( months != Integer.MAX_VALUE ){
            for( int i = 0; i<months; i++){
                ...
                adapter.addFrag(new com.hcmut.moneymanagement.activity.Events.FragmentIE(startDate, endDate, month), str_month);
            }
        }
